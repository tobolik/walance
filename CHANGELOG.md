...
- Barevné zvýraznění: teal = aktuální kontakt, amber = slučovaný, blue = spojit obě (jen poznámky)
...
- Slučování kontaktů – vyhledávací modal, přesun rezervací a aktivit, sloučení poznámek
- Editace aktivit – modal s úpravou typu, předmětu, obsahu a směru
- Mazání aktivit – potvrzovací dialog a soft-delete

### Změněno
- Stránka kontaktu přepracována na AJAX – formuláře bez reloadu stránky, toast notifikace
...
### Přidáno
- **Story – „O autorce metody":** přidán obrázek jana-linkedin.jpg (800×800) vlevo vedle textu, responsivní layout (sloupce na desktopu, pod sebou na mobilu)

## [2.4.4] – 17.02.2026 19:55
> Pushed: 17.02.2026 19:55

### Změněno
- **Slovníček reality:** Deep work přesunut do skryté části, viditelné zůstávají 3 kartičky (WALANCE, Prezentismus, Brain fog)
...
- Každá kartička má ikonu (SVG), název, krátký popis a po kliknutí rozbalovací detail „Co s tím"
...
## [2.0.0] – 17.02.2026 16:57
> Pushed: 17.02.2026 16:57
...
### Změněno
- **Booking modal:** po výběru času se automaticky nastaví focus na pole „Jméno a příjmení"
- **Booking modal:** pole „Jméno" přejmenováno na „Jméno a příjmení" (sjednocení s kontaktním formulářem)
