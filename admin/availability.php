        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            ...
            <form method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <p class="text-slate-600 text-xs mt-2 p-2 bg-slate-50 rounded border border-slate-200"><strong>Čtení:</strong> Každý kalendář musí být sdílen s tímto Service Accountem: <code class="bg-slate-100 px-1 rounded font-mono text-xs break-all"><?= htmlspecialchars($serviceAccountEmail ?? 'walance-calendar@kalendar-pro-walance.iam.gserviceaccount.com') ?></code> – v Google Calendar → Nastavení kalendáře → Sdílet s konkrétními lidmi → přidejte tento e-mail s oprávněním „Zobrazit všechny podrobnosti události“. Sdílené kalendáře se v roletce zobrazí až po uložení.</p>
                    <p class="text-slate-600 text-xs mt-1 p-2 bg-teal-50 rounded border border-teal-200"><strong>Zápis:</strong> Rezervace se zapisují do <em>prvního</em> kalendáře v seznamu. Pro zápis do kalendáře kolegy (např. jana@firma.cz) je potřeba <strong>Domain-Wide Delegation</strong> – viz <a href="../docs/GOOGLE-CALENDAR-DELEGATION.md" target="_blank" class="text-teal-700 underline">docs/GOOGLE-CALENDAR-DELEGATION.md</a>.</p>
                </div>
                <?php endif; ?>
                <div>
